...
namespace РОСАTest.Common.Enums
{
    public static class StatusEnum
    {
        ...
        public static readonly Guid PartialyCompleted = StatusesSeed.Statuses[3].Id;
        public static readonly Guid Revoked = StatusesSeed.Statuses[4].Id;
        public static readonly Guid Rejected = StatusesSeed.Statuses[5].Id;
    }
}
